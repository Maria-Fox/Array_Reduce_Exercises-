...
function vowelCount(str) {
  let casedStr = str.toLowerCase().split("");
  let vowels = "aeiou";

  return casedStr.reduce(function (accum, nextValue) {
    if (vowels.indexOf(nextValue) !== -1) {
      //str does have a vowel
      if (accum[nextValue]) {
        // if already gone through "else" section
        accum[nextValue]++;
        // console.log(casedStr);
        // console.log(accum);
        // console.log(accum, nextValue);
      } else {
        accum[nextValue] = 1;
      }
    }
